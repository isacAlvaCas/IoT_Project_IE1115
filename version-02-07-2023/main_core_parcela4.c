...
PROCESS_THREAD(init_system_process, ev, data) {
  ...
  while(1) {
      ...
      //printf("\nMessage sent. Topic: /data_4 Data:%s Time:%lu Energy:%d",  pub_test, time, energy_value);
      //printf("\nMessage sent. Topic: /data_4 Data:%s Time:%lu H:%d",  pub_test, time, humedad);
